...
client.on('interactionCreate', function _callee2(interaction) {
      ...
      switch (_context2.prev = _context2.next) {
        ...
        case 64:
          ...
          return regeneratorRuntime.awrap(axios.post("".concat(API_URL, "/execute"), {
            ...
            headers: {
              'Authorization': "Bearer ".concat(BOT_API_TOKEN)
            }
          }));
        ...
        case 84:
          ...
          _context2.prev = 86;
          _context2.next = 89;
          return regeneratorRuntime.awrap(axios.get("".concat(API_URL, "/websiteStatus"), {
            headers: {
              'Authorization': "Bearer ".concat(BOT_API_TOKEN)
            },
            params: {
        ...
        case 94:
          ...
          console.error("Error checking website status: ".concat(_context2.t4.message));
          _context2.next = 99;
  ...
  }, null, null, [[8, 16], [27, 35], [46, 54], [66, 74], [86, 94]]);
});
    ...
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          ...
          _context7.next = 6;
          return regeneratorRuntime.awrap(rest.put(Routes.applicationCommands(CLIENT_ID), {
            body: commands
          }));
